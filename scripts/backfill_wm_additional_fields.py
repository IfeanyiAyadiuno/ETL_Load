...
_EXCEL_HEADER_TO_KEY = {
    ...
    "fluid pumped (m³)": "fluid_pumped_m3",
    "fluid pumped (m3)": "fluid_pumped_m3",
    "proppant pumped (t)": "proppant_pumped_t",
    "proppant pumped (tonnes)": "proppant_pumped_t",
    "initial flow date": "initial_flow_date",
}
